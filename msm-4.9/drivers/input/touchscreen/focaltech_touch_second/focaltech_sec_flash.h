...
*
************************************************************************/
#ifndef __LINUX_FOCALTECH_SEC_FLASH_H__
#define __LINUX_FOCALTECH_SEC_FLASH_H__
...
*****************************************************************************/
extern struct upgrade_func upgrade_func_ft5422_sec;
...
int fts_sec_flash_write_buf(u32 saddr, u8 *buf, u32 len, u32 delay);
