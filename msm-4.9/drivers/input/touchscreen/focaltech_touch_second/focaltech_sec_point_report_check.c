...
*****************************************************************************/
/*****************************************************************************
*  Name: fts_sec_prc_func
*  Brief: fts point report check work func, report whole up of points
*  Input:
*  Output:
*  Return:
*****************************************************************************/
static void fts_sec_prc_func(struct work_struct *work)
{
...
/*****************************************************************************
*  Name: fts_sec_point_report_check_init
*  Brief:
*  Input:
*  Output:
...
int fts_sec_point_report_check_init(struct fts_ts_data *ts_data)
{
    ...
    if (ts_data->ts_workqueue) {
        INIT_DELAYED_WORK(&ts_data->prc_work, fts_sec_prc_func);
    } else {
...
/*****************************************************************************
*  Name: fts_sec_point_report_check_exit
*  Brief:
*  Input:
*  Output:
*  Return:
