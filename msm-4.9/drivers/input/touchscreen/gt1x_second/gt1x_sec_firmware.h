/* drivers/input/touchscreen/gt1x_sec_firmware.h
 *
...
#ifndef _GT1X_SEC_FIRMWARE_H_
#define _GT1X_SEC_FIRMWARE_H_

unsigned char gt1x_sec_default_FW[] = 
{
};

#if GTP_HOTKNOT
unsigned char gt1x_sec_patch_jump_fw[] = {
